...
async function main() {
  ...
  // --- 2. CREATE A DUMMY INSTRUCTOR ---
  // This user will be the owner of the seeded courses
  const instructor = await prisma.user.create({
    data: {
      email: "instructor@castpotro.com",
      password: "hashed_password_here",
  ...
  const coursesData = [
    {
      title: "Intro to Large Language Models",
      description:
        "Learn the fundamentals of LLMs, how ChatGPT works, and the future of Generative AI.",
      icon: "BrainCircuit",
      creatorId: instructor.id, // Fixed: Added creatorId relation
      units: {
        create: [
          {
            title: "Basics of LLMs",
              ...
              create: [
                {
                  title: "What is an LLM?",
                  theory:
                    "Large Language Models are deep learning algorithms that can recognize, summarize, translate, predict and generate text.",
                  videoUrl: "https://www.youtube.com/watch?v=zjkBMFhNj_g",
                },
                {
                  title: "How Transformers Work",
                  theory:
                    "Attention mechanisms allow models to weigh the importance of different words in a sentence.",
                  videoUrl: "https://www.youtube.com/watch?v=4Bdc55j80l8",
                },
              ],
            },
    ...
    },
    {
      title: "The Art of Public Speaking",
      description:
        "Master the art of persuasion, body language, and overcoming stage fright.",
      icon: "Mic",
      creatorId: instructor.id, // Fixed: Added creatorId relation
      units: {
        create: [
              ...
              create: [
                {
                  title: "Overcoming Stage Fright",
                  theory:
                    "Fear is excitement without breath. Learn to breathe correctly.",
                  videoUrl: "https://www.youtube.com/watch?v=i5mYphUoOCs",
                },
              ],
            },
    ...
    },
    {
      title: "Python for Beginners",
      description:
        "A complete introduction to Python programming. From variables to building your first app.",
      icon: "Code",
      creatorId: instructor.id, // Fixed: Added creatorId relation
      units: {
        create: [
    ...
    },
    {
      title: "Startup 101: Zero to One",
      description:
        "Legendary lectures on how to build a billion-dollar company.",
      icon: "Rocket",
      creatorId: instructor.id, // Fixed: Added creatorId relation
      units: {
        create: [
    ...
    },
    {
      title: "Communication for Engineers",
      description:
        "How to communicate complex technical ideas to non-technical stakeholders.",
      icon: "MessageCircle",
      creatorId: instructor.id, // Fixed: Added creatorId relation
      units: {
        create: [
              ...
              create: [
                {
                  title: "Technical Storytelling",
                  theory:
                    "Don't just list features, tell a story about the user.",
                  videoUrl: "https://www.youtube.com/watch?v=HAnw168huqA",
                },
              ],
            },
  ...
  const events = [
    {
      title: "AI Summit Dhaka 2026",
      description:
        "Join the biggest gathering of AI researchers and enthusiasts in Bangladesh.",
      date: new Date("2026-03-15T10:00:00Z"),
      location: "UIU Campus, Dhaka",
      type: "Physical",
      status: "UPCOMING",
