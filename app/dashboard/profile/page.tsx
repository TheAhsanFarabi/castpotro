      ...
      <div className="hidden xl:flex flex-col w-[240px] 2xl:w-[300px] bg-slate-50/50 p-8 h-screen sticky top-0 overflow-y-auto custom-scrollbar gap-8 shrink-0 border-l-2 border-slate-100">
        ...
        <div className="border-2 border-slate-200 rounded-3xl p-6 bg-white shadow-sm hover:shadow-lg transition-shadow duration-300">
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="bg-slate-100 p-2 rounded-xl text-slate-400 hover:text-[#0ea5e9] hover:bg-sky-50 transition-colors"><UserPlus size={18} /></button>
          </div>
          <div className="space-y-4">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="flex items-center gap-3 group cursor-pointer">
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-lg transition-transform group-hover:scale-110 ${i % 2 === 0 ? "bg-purple-100 text-purple-600" : "bg-orange-100 text-orange-600"}`}>{i % 2 === 0 ? "👩‍🚀" : "🦸‍♂️"}</div>
                <div className="flex-1">
