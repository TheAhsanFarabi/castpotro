...
function ProfileContent() {
  ...
  // --- PDF Generation Logic (Optimized) ---
  const generateCV = async () => {
    ...
    yPos += 8;
    doc.text(`Joined: January 2026`, 20, yPos);
    ...
    RECENT_ACTIVITY.forEach((activity) => {
        doc.text(`• ${activity.title} (${activity.date}) - ${activity.xp}`, 25, yPos);
        yPos += 8;
    });
  ...
  return (
    <div className="flex w-full h-full">
      ...
      <div className="flex-1 overflow-y-auto bg-white relative scroll-smooth">
        ...
        {/* Sticky Header with Consistent Width Wrapper */}
