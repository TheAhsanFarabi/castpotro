...
export default function LearningClient({
  ...
  const handleAiEvaluation = async () => {
    // 1. Calculate Score & Prepare Detailed Context
    let currentScore = 0;

    // Create a readable list of questions and results for the AI
    ...
    // 2. ENHANCED PROMPT WITH QUESTIONS
    // Now the AI knows exactly what was asked and what was missed.
    const prompt = `
      ...
      TASK:
      Feedback: A single, specific sentence evaluating my understanding of "${lesson.title}". If I got questions wrong, mention the specific concept I missed.

      CONSTRAINTS:
      - Focus ONLY on the lesson topic and quiz concepts.
      - DO NOT mention "Castpotro", "the platform", "website", or "course".
      - DO NOT use generic phrases like "As an AI".
      - Be direct, coaching, and concise.
    ...
    try {
      ...
      setAiFeedback(
        "Great work! Try to apply these concepts in your next conversation.",
      );
    } finally {
