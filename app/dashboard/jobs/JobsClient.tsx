...
//                         </div>
//                       )}
//                       {/* NEW: Show indicator if a screening task is required */}
...
//                       <button
//                         disabled
//                         className="px-6 py-2.5 rounded-xl font-extrabold uppercase tracking-wider text-sm flex items-center gap-2 bg-emerald-100 text-emerald-600 border border-emerald-200 cursor-default"
//                       >
//                         <CheckCircle size={16} /> Applied
//                       </button>
//                     ) : (
