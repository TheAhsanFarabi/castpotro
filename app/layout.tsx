...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        {/* --- GLOBAL BACKGROUND DECORATION (Blue & Pink) --- */}
        <div className="fixed inset-0 z-[-1] pointer-events-none overflow-hidden">
           {/* Base Layer */}
           <div className="absolute top-0 left-0 w-full h-full bg-slate-50" /> 
           
           {/* Gradient Overlay */}
           <div className="absolute top-0 left-0 w-full h-[600px] bg-gradient-to-b from-sky-100/60 to-transparent" />
           ...
           {/* Blue Blob */}
           <div className="absolute top-[200px] left-[-200px] w-[500px] h-[500px] bg-sky-400/20 rounded-full blur-[100px] opacity-60" />
        </div>
