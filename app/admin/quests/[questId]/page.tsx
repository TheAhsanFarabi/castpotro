...
export default async function QuestVerificationPage({
  params,
}: {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <Link
        href="/admin/quests"
        className="flex items-center gap-2 text-slate-400 font-bold mb-6 hover:text-slate-600 transition"
      >
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        {quest.submissions.map((sub) => (
          <div
            key={sub.id}
            className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm flex flex-col lg:flex-row gap-8"
          >
