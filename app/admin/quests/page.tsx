...
import { Plus, Target, Zap, Clock, Shield, Trash2, Eye } from "lucide-react";
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <div>
            <h1 className="text-3xl font-bold text-slate-800">Quest Management</h1>
            <p className="text-slate-500">Create SDG challenges and verify impact.</p>
        </div>
        <Link href="/admin/quests/new" className="bg-[#0ea5e9] text-white px-6 py-3 rounded-xl font-bold flex items-center gap-2 hover:bg-sky-600 transition shadow-lg shadow-sky-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {quests.map(quest => (
          <div key={quest.id} className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between h-full relative overflow-hidden group">
             ...
             <div>
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        <span className="text-[10px] font-black uppercase text-slate-400 tracking-wider block">{quest.frequency}</span>
             ...
             <div className="flex items-center gap-2 mt-auto pt-4 border-t border-slate-100">
                <Link href={`/admin/quests/${quest.id}`} className="flex-1 bg-slate-800 text-white py-2 rounded-lg text-center text-sm font-bold hover:bg-slate-700 flex items-center justify-center gap-2">
